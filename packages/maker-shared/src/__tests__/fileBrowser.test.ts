...
describe('file browser shared model', () => {
  it('builds sorted directory and file rows for the read-only file page', () => {
  ...
  it('summarizes directory rows for the file page header', () => {
    const rows = buildMobileDirectoryEntries([
      { kind: 'dir', name: 'src', path: '/repo/src' },
      { kind: 'symlink', name: 'linked', path: '/repo/linked' },
  ...
  it('builds a selected-file action panel', () => {
