...
<p align="center">
  🌐 <a href="https://cindy.com.cn">cindy.com.cn</a>(国内) · <a href="https://cindy.app">cindy.app</a>(海外)
</p>

Cindy 运行在你自己的电脑上,使用你本地的文件和已登录的应用,底层由
[Claude Code](https://www.anthropic.com/claude-code) 与 Codex 作为 agent 引擎驱动。
