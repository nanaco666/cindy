...
- The task only fires while the desktop app (or the scheduler subprocess) is running on your machine — it's a local scheduler, not a cloud cron. Closing the app means tasks won't fire until you reopen it.
