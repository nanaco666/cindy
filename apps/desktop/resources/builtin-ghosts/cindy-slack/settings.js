...
(function () {
  ...
  var CONNECT_ERROR_TEXT = {
    ...
    LISTEN_FAILED: '本机 53683 端口被占用且无法自动释放,请手动关闭占用它的程序后重试',
  ...
  $('connect-rw').addEventListener('click', function () { void connect(false); });
  $('connect-ro').addEventListener('click', function () { void connect(true); });
  void load();
})();
