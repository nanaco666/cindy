...
!macro customInstall
  ; 注册文件夹右键菜单 "通过 XDMaker 打开" (与 main/folderContextMenu.ts 写的是同一组键)。
  ...
  WriteRegStr HKCU "Software\Classes\Directory\shell\xdt-maker" "" "通过 XDMaker 打开"
  ...
  WriteRegStr HKCU "Software\Classes\Directory\Background\shell\xdt-maker" "" "通过 XDMaker 打开"
  ...
  WriteRegStr HKCU "Software\Classes\SystemFileAssociations\.cshare\shell\xdt-maker" "" "通过 XDMaker 打开"
  ...
  WriteRegStr HKCU "Software\Classes\SystemFileAssociations\.xdtshare\shell\xdt-maker" "" "通过 XDMaker 打开"
