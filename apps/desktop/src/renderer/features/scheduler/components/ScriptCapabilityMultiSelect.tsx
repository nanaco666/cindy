 ...
 * ---------------------------------------------------------------------------
 * 能力目录来自 @lizi/maker-scheduler 的 SCRIPT_CAPABILITIES(与引擎校验白名单
...
// ⚠ 必须走 /types 子路径:主入口("@lizi/maker-scheduler")会连带导出 engine
// (node:events 的 EventEmitter),renderer 侧 Vite externalize 后模块求值即白屏。
import { SCRIPT_CAPABILITIES, type ScriptCapability } from '@lizi/maker-scheduler/types';
