/**
 * CodexMark —— OpenAI 官方六瓣 logo,单色 currentColor 灰阶友好。
 *
 * SVG path 与 components/settings/ConnectionsSection.tsx:34-49 同源(viewBox 24×24)。
 * 公共化是为了让 NewMaker vendor switcher / 未来 sidebar / 其它入口共享同一份 mark。
 */
