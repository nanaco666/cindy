...
const overrides = {
  ...
  'sidebar-top-card-bg': 'rgba(255, 255, 255, 0.05)', // 补编 §2
  'sidebar-top-card-border': 'rgba(255, 255, 255, 0.13)', // 补编 §2
  ...
  'update-btn-border': '#EEEEEE', // E1D 中性边
  'update-btn-text': '#252222', // E1D 中性字
