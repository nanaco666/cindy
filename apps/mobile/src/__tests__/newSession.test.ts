...
describe('new session composer surface', () => {
  it('uses the shared mobile composer row rather than a separate input implementation', () => {
    ...
    expect(newComposerSource).toContain('inputStyle={voiceIsListening && styles.inputVoiceHidden}');
    ...
    expect(sharedSource).toContain('export const MOBILE_COMPOSER_CONTROL_SIZE = 28;');
