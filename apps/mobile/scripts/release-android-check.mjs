...
let RELEASE_RECORD_CDN;   // `${CDN_BASE}/mobile-ota/android/release.json`
...
function nextStepFor(mode, region) {
  ...
  return ['→ 线上无基线(首发或 release.json 未上传):按首次冷更处理', `   ${formatSelfHostReleaseCommand('android', 'local', region, { execute: true })}`];
}
