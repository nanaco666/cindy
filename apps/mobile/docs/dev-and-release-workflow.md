...
- **签名**:自有 keystore `Cindy.jks`(alias `Cindy`,PKCS12,2026-07-16 起替换旧 `xdmaker-release`;打包机 `/Users/cn-ios/Documents/cindy/CindyMobileCer/Android/`,口令走环境变量,不入仓);Android 自签即终版,NPKG **只上传取下载链接、不重签**。换 keystore + 换包名 = 全新安装线,旧 `com.xd.lizcn` 自建包无法覆盖安装。
