...
Pod::Spec.new do |s|
  ...
  s.summary        = 'Realtime PCM microphone capture for XDMaker mobile voice input.'
  s.description    = 'Expo module that streams iOS microphone audio as PCM16 chunks for XDMaker mobile realtime dictation.'
