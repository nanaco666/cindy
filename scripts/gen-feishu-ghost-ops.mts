 ...
 * 产物:替换 apps/desktop/resources/builtin-ghosts/xd/xd-feishu/main.js 中
 *       (xd-feishu 种子已随 2026-07-22 拆仓迁入 cindy-xd-plugin submodule,
 *       改动需在子仓提交并 bump 主仓指针)
...
const MAIN_JS = path.join(
  ROOT,
  'apps/desktop/resources/builtin-ghosts/xd/xd-feishu/main.js',
);
